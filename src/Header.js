            ...
            <div className="border">
                <div className="card bg-dark text-white" style={{borderRadius: '0px'}}>
                    ...
                    <div className="card-img-overlay">
                        <div className="row">
                            <div className="col">
                                <span><img src={movieIcon} alt="icon"/></span><h3 style={{display: 'inline'}}> MovieBox</h3>
                            </div>
                            <div className="col-sm-6">
                                <span>
                                  <input className="bg-transparent text-white" style={{borderColor:"white", borderRadius:"15px", width:'500px',height: 35+'px'}} type="text" placeholder="What do you want to watch?" />
                                  <span className="btn bg-grey text-success" style={{marginLeft:"10px", width:"40px"}}><i class="fa fa-search" aria-hidden="true"></i></span>
                                </span>
                            </div>
